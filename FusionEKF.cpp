...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
    ...
    if (!is_initialized_) {
        ...
        if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
            ...
            // Getting measurement values and storing them
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
        ...
        // Getting an instance of Tools class to computer Jacobian
        Tools tools;
        
        // CalculateJacobian() method uses State Vector to calculate Jacobian Matrix
        Hj_ = tools.CalculateJacobian(ekf_.x_);
        
        // Setting up Measurement Matrix
        ekf_.H_ = Hj_;
        ...
        // This uses Taylor Serious Expansion for Linear Approximation
